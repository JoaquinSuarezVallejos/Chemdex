...
namespace Atom
{
    public class ThirdParticleLvl1 : ParticleLvl1
    {
        ...
        new public void PickUpParticle() // called when the neutron is picked up from the atom
        {
            ...
            if (inAtom && atom.Nucleus.RemoveParticle(this))
            {
                ...
                Debug.Log("Third Particle Removed");
            }
            else
            {
        ...
        new public void DropParticle() // called when the neutron is dropped into the atom
        {
            ...
            if (!inAtom && (!atom.Interactable || atom.Contains(transform.position) || (atom.Nucleus.ProtonCount == 0 && atom.Nucleus.NeutronCount == 0)) && atom.Nucleus.AddParticle(this))
            {
                ...
                Debug.Log("Third Particle Added");
            }
